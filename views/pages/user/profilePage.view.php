    ...
    <div class="col-12 col-lg-10 col-xl-8 col-xxl-6 mx-auto border border-3 border-primary mt-5 rounded-3 box-shadow-white fs-5">
        ...
        <div class="my-4" method="POST" action="validation_login">
            ...
            <div class="w-75 mx-auto my-5">
                <p><span class="h3">Pseudo : <br> </span> <?= $datasUser['login'] ?></p>
                <p><span class="h3">Role : <br></span> <?= $datasUser['role'] ?></p>
                <p id="btnModifyMail" class="cupo"><span class="h3">Mail : <br></span> <?= $datasUser['mail'] ?> <i class="fa-solid fa-pen"></i></p>
                <!-- bloc de modification de l'email  -->
                <div class="d-none" id="formModifyMail">
                    <?php require_once("views/components/modifyMailBlock.php")  ?>
                </div>
                <p id="btnModifyPassword" class="cupo"><span class="h3">Mot de passe : <br></span> modification <i class="fa-solid fa-pen"></i></p>
