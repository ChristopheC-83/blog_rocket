<!-- header  :une video tournant en fond, Bootstrap fut peu coopératif => custom CSS pour bien faire -->
          ...
          <h2 class="arizona text-center display-2 text-shadow-white">
            ...
            <div class=" d-xl-block ">
              <h2 class="arizona text-center display-3  text-shadow-white">
                <?= isset($title_page) ? $title_page : "Tu as cherché une page non règlementaire ! 🫣" ?>
              </h2>
          </h2>
      </div>
